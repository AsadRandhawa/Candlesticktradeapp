...
const Dashboard = () => {
  ...
  //   let roundedMEO1 = parseFloat(MEO1.toFixed(2)); // Round to 2 decimal places
  //   setEO1(roundedMEO1);
  //   console.log("Value of Entryprice:", roundedMEO1)};

  const handleEEEO1 = (evt) => {
    let EEO1 = evt.target.value;
    let MEO1 = Number(EEO1.replace(/,/g, "")); // Convert the input to a number without commas
    setEO1(MEO1);  // Directly set the number without rounding
     // Log the original number without rounding
};
...
console.log("value before fo",EO1)
  const fields = [
    {
...
toFixed(2)
    ...
    },
    {
      ...
      value:
        Currency + parseFloat(((GO2 * 100) / 100).
toFixed(2)).toLocaleString(),
      color: "#67C839",
    },
    {
      title: "Take Profit",
      value: Currency + parseFloat(FO3.
toFixed(2)).toLocaleString(),
      color: "#67C839",
      marginBottom: "0px",
    },
...
toFixed(2)
    ...
    },
    {
      ...
      value: Currency + parseFloat((GO1 - EO1).toFixed(3)).toLocaleString(),
      color: "#9191A6",
    },
    {
      title: "Trade Range",
                ...
                <div className="col-6">
                  <h6 style={{ color: "#7071A4" }}>
                    ...
                    <span style={{ color: "rgb(103, 200, 57)" }}>
                      {Currency + " " + num.format(LO5.
toFixed(2))}
                    </span>
                  </h6>
                  <h6 style={{ color: "#7071A4" }}>
                    Rol{" "}
                    <span style={{ color: "#CBCBE2" }}>{HO1.
toFixed(2)} %</span>
                  </h6>
                </div>
