...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    EO1 * EO2 * JO1 * 0.01 * MO1 === -Infinity
      ? setJO2(0)
      : setJO2((((EO1 * EO2 * JO1 * MO1) / 100) * 10) / 10);

    !(EO1 * 1 + (EO1 * JO2) / HO2) ||
    EO1 * 1 + (EO1 * JO2) / HO2 === Infinity ||
    EO1 * 1 + (EO1 * JO2) / HO2 === -Infinity
      ? setKO2(0)
      : setKO2((EO1 + (EO1 * JO2) / HO2).toFixed(2));
  ...
  const fields = [
    ...
    // },
    {
      ...
      Currency + 
      (IO2 
         ? parseFloat((HO2 * (IO1 / 100)).toFixed(2)).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })
         : parseFloat((0).toFixed(2)).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })
      ),
      color: "#FF0000",
    },
    {
    ...
    },
    {
      ...
      value:
        Currency +
        parseFloat(KO2 - (EO1 - IO1 * 0.01 * EO1).toFixed(3)).toLocaleString(),
      color: "#9191A6",
    },
